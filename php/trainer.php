    ...
    <div class="collapse navbar-collapse" id="myNavbar">
	  ...
	  <ul class="nav navbar-left" style="color:black">
		<li class="dropdown"  style="color:black">
			<a href="notification.php" class="dropdown-toggle" data-toggle="dropdown" ><span class="label label-pill label-danger count" style="border-radius:10px;" ></span> 
	...
	<section>
		<div class="row ">
			<div class="col-md-3 " id="profile_picture">
				...
				<h2 ><b>Welcome Mr. <?php echo $_SESSION["lasttName"]. ' ' .$_SESSION["firstName"];?></h2><br><br>
				...
				<form action="" method="post">
					<p><label>Choose your Patient:<select id="Patient_id" name="Patient_id" class="form-control">
							<?php
								$sql_p = "select * from patients as p inner join patientandtrainerrelated as rl on p.ID_Number = rl.patientID where rl.trainerID like '%". $_SESSION["ID"]. "%';";
			...
			<center>
				<div class="col-md-12">
					...
					<button type="button" id="btn3" class="btn btn-warning"><b>Edit<a href="#"></a></button><br><Br><br>
				</div>
				<div class="col-md-12">
					...
					<button type="button" id="btn4" class="btn btn-warning"><b>View<a href="#"></a></button>
				</div>
			</center>
			</div>
			</div>
...
$(document).ready(function(){
 ...
 {
  $.ajax({
   url:"php-notifications-master/fetch.php",
   method:"POST",
   data:{view:view},
   dataType:"json",
